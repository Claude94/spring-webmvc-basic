...
class ReplyMapperTest {
    ...
    void readTest() {
        Reply findReply = replyMapper.read(24);
        System.out.println("------------------------------");
        System.out.println("findReply = " + findReply);
//        assertEquals("테스트  댓글24", findReply.getReplyText());
    ...
    @Test
    @DisplayName("특정 게시글을 삭제할 수 있어야 한다")
    @Rollback @Transactional
    void deleteTest() {
        replyMapper.delete(20);
        replyMapper.delete(10);
